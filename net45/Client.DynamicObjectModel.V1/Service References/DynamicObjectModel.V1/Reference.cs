...
namespace Client.DynamicObjectModel.V1.DynamicObjectModel.V1 {
    ...
    public interface DynamicObjectModel {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://www.gecko.no/ephorte/services/dynamicobjectmodel/v1/DynamicObjectModel/Exe" +
            "cuteTask", ReplyAction="http://www.gecko.no/ephorte/services/dynamicobjectmodel/v1/DynamicObjectModel/Exe" +
            "cuteTaskResponse")]
        System.Threading.Tasks.Task<Client.DynamicObjectModel.V1.DynamicObjectModel.V1.TaskResult[]> ExecuteTaskAsync(Client.DynamicObjectModel.V1.DynamicObjectModel.V1.EphorteIdentity identity, Client.DynamicObjectModel.V1.DynamicObjectModel.V1.Task[] tasks);
    }
    ...
    public partial class DynamicObjectModelClient : System.ServiceModel.ClientBase<Client.DynamicObjectModel.V1.DynamicObjectModel.V1.DynamicObjectModel>, Client.DynamicObjectModel.V1.DynamicObjectModel.V1.DynamicObjectModel {
        ...
        public System.Threading.Tasks.Task<Client.DynamicObjectModel.V1.DynamicObjectModel.V1.TaskResult[]> ExecuteTaskAsync(Client.DynamicObjectModel.V1.DynamicObjectModel.V1.EphorteIdentity identity, Client.DynamicObjectModel.V1.DynamicObjectModel.V1.Task[] tasks) {
