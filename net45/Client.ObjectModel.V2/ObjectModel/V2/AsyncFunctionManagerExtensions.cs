...
namespace Gecko.NCore.Client.ObjectModel.V2
{
    ...
    public static class AsyncFunctionManagerExtensions
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static async System.Threading.Tasks.Task<IDictionary<int, string>> HentJournalpostAktivitetsmalerAsync(this IAsyncFunctionManager instance)
        {
        ...
        public static async System.Threading.Tasks.Task OpprettJournalpostAktivitetsflytAsync(this IAsyncFunctionManager instance, int templateId, int journalpostId, int position, bool asSibling, IEnumerable<AvsenderMottaker> mottakere)
        {
        ...
        /// <returns></returns>
        public static async System.Threading.Tasks.Task<IEnumerable<Dokumentmal>> HentDokumentmalAsync(this IAsyncFunctionManager instance, int journalpostId, int dokumentbeskrivelseId, params int[] dokumentmalTypeIds)
        {
        ...
        /// <param name="personIds">The person ids.</param>
        /// <returns></returns>
        public static async System.Threading.Tasks.Task<int> OpprettTilgangsgruppeAsync(this IAsyncFunctionManager instance, Journalpost journalpost, params int[] personIds)
        {
            if (instance == null)
                throw new ArgumentNullException("instance");
            ...
            if (!journalpost.Id.HasValue)
                throw new InvalidOperationException("Journalpost må ha en Id.");

            return (int)await instance.ExecuteAsync("OpprettTilgangsgruppeHandler", 0, journalpost.Id.Value, string.Join(",", personIds.Select(x => x.ToString(CultureInfo.InvariantCulture)).ToArray()));
        }
    }
}
