...
namespace Gecko.NCore.Client.Functions.V1 {
    ...
    public interface FunctionsService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://www.gecko.no/ephorte/services/functions/v1/FunctionsService/QueryFunctionD" +
            "escriptors", ReplyAction="http://www.gecko.no/ephorte/services/functions/v1/FunctionsService/QueryFunctionD" +
            "escriptorsResponse")]
        System.Threading.Tasks.Task<Gecko.NCore.Client.Functions.V1.FunctionDescriptor[]> QueryFunctionDescriptorsAsync(Gecko.NCore.Client.Functions.V1.EphorteIdentity identity);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://www.gecko.no/ephorte/services/functions/v1/FunctionsService/ExecuteFunctio" +
            "n", ReplyAction="http://www.gecko.no/ephorte/services/functions/v1/FunctionsService/ExecuteFunctio" +
            "nResponse")]
        System.Threading.Tasks.Task<Gecko.NCore.Client.Functions.V1.FunctionResult> ExecuteFunctionAsync(Gecko.NCore.Client.Functions.V1.EphorteIdentity identity, string name, object[] parameters);
    }
    ...
    public partial class FunctionsServiceClient : System.ServiceModel.ClientBase<Gecko.NCore.Client.Functions.V1.FunctionsService>, Gecko.NCore.Client.Functions.V1.FunctionsService {
        ...
        public System.Threading.Tasks.Task<Gecko.NCore.Client.Functions.V1.FunctionDescriptor[]> QueryFunctionDescriptorsAsync(Gecko.NCore.Client.Functions.V1.EphorteIdentity identity) {
        ...
        public System.Threading.Tasks.Task<Gecko.NCore.Client.Functions.V1.FunctionResult> ExecuteFunctionAsync(Gecko.NCore.Client.Functions.V1.EphorteIdentity identity, string name, object[] parameters) {
