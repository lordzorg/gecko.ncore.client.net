	...
	internal abstract class ExpressionVisitor
	{
		...
		protected virtual Expression VisitBinary(BinaryExpression b)
		{
			...
			if (left != b.Left || right != b.Right || conversion != b.Conversion)
			{
				...
				// If the types don't match up we add a Conversion to make them match.
				// If we don't do this, the Expression.MakeBinary will fail if it tries to match two different types. E.g. a Nullable<bool> and a regular bool.
