...
namespace Gecko.NCore.Client.StateTracking
{
    ...
    {
        private readonly Func<IQueryProvider> _queryProviderResolver;

        public StateManager(Func<IQueryProvider> queryProviderResolver)
        {
            _queryProviderResolver = queryProviderResolver;
        }
    	...
    	public void Add(object dataObject)
        {
    	    ...
    	    ProcessDataObjectCollections(dataObject, _queryProviderResolver());
        ...
        private void WeaklyAttachedDataObjectChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            ProcessDataObjectCollections(sender, _queryProviderResolver());
